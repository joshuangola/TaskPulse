...
const Statistics = ({ stats, sessionCount, showStats, setShowStats }) => {
  const today = new Date().toDateString();
  const todayStats = stats[today] || { sessions: 0, workTime: 0, breakTime: 0 };
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full py-3 px-4 rounded-lg font-medium transition-all bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white shadow-lg hover:shadow-xl transform hover:scale-105"
        >
              ...
              <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg border border-green-200 dark:border-green-700">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-bold text-green-900 dark:text-green-100">
                    {formatTime(todayStats.workTime)}
                  </span>
                </div>
              </div>
              ...
              <div className="p-4 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-lg border border-yellow-200 dark:border-yellow-700">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-bold text-yellow-900 dark:text-yellow-100">
                    {formatTime(todayStats.breakTime)}
                  </span>
                </div>
              </div>
